...
def main():
    ...
    tokenize_fw(train_fw, split='train', data_name=data_name, max_length=100000, upload_repo=args.upload_repo, token=token, shard_size=args.shard_size, data_cache_dir=DATA_CACHE_DIR) # don't trim training data
